...
Installation: `sudo apt update && sudo apt install metasploit-framework`
...
# Information about current exploit
msfconsole info 

# setg can be used for global persistent change
setg RHOSTS <IP>

# Show all vulnerable targets 
show targets 

# Searching for Payloads / Encoders
show payloads 
show encoders 
 ```
...
# Example of msfvenom to create an executable backdoored installer
